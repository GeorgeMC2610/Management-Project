...
namespace Management_Project
{
    public partial class Form1 : Form
    {
        ...
        {
            MessageBox.Show("Δεξιά της οθόνης σας κάτω από την φράση «Επεξεργασία τράπεζας» θα βρείτε ένα ΠΡΑΣΙΝΟ κουμπί,ονόματι ΠΡΟΣΘΗΚΗ ΝΕΟΥ ΘΕΜΑΤΟΣ. Πατώντας αυτό το κουμπί θα μπορείτε να ξεκινήσετε τη δημιουργία και την επεξεργασία ενός νέου θέματος! Μπορείτε να επιλέξετε: \n\n Ερώτηση \n Κεφάλαιο \n Βαθμό δυσκολίας \n Αριθμό πιθανών απαντήσεων \n\nΣτο τέλος μπορείτε να επιλέξετε ΕΠΙΣΚΟΠΗΣΗ ΘΕΜΑΤΟΣ για να δείτε τη τελική μορφή της ερώτησης ή ΠΡΟΣΘΗΚΗ ΕΡΩΤΗΣΗΣ ΣΤΗΝ ΤΡΑΠΕΖΑ εφόσον αποφασίσετε ότι η ερώτηση σας είναι έτοιμη να μπει στη τράπεζα θεμάτων.Πάντα θα έχετε τη δυνατότητα προβολής και διαγραφής κάποιου υπαρκτού θέματος,οπότε μην αγχώνεστε αν κάποια ερώτηση είναι λάθος καθώς θα μπορείτε να την αλλάξετε! \n\nΑν θέλετε να επιστρέψετε στην αρχική διαφάνεια πατήστε πάνω δεξιά το κουμπί «Επιστρογή στο Μενού»", "Προσθήκη Νέου Θέματος");
        }

        private void toolStripMenuItem3_diagrafh_olwn_twn_thematwn_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Δεξιά της οθόνης σας βρίσκεται ένα ΚΟΚΚΙΝΟ κουμπί ονόματι ΔΙΑΓΡΑΦΗ ΟΛΩΝ ΤΩΝ ΘΕΜΑΤΩΝ. Το κουμπί αυτό διαγράφει ΟΛΑ τα θέματα που έχουν δημιουργηθεί. \n\nΤα θέματα που θα διαγραφούν ΔΕΝ γίνεται να ανακτηθούν εφόσον έχουν διαγραφτεί.", "ΔΙΑΓΡΑΦΗ ΟΛΩΝ ΤΩΝ ΘΕΜΑΤΩΝ");
        }

        private void toolStripMenuItem4_episkophsh_thematwn_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Δεξιά της οθόνης σας βρίσκεται ένα ΓΚΡΙ κουμπί ονόματι ΕΠΙΣΚΟΠΗΣΗ ΘΕΜΑΤΩΝ.\n\nΤο κουμπί αυτό θα σας εμφανίσει τις ερωτήσεις και τις πιθανές απαντήσεις των θεμάτων,η σωστή ερώτηση πάντα θα υπογραμμίζεται με πράσινο και ο βαθμός δυσκολίας με το κεφάλαιο θα αναγράφονται πάνω αριστερά. \n\nΜπορείτε να επιστρέψετε στο αρχικό μενού πατώντας «Επιστροφή στο μενού». \n\nΣτο κάτω μέρος της οθόνης παρουσιάζονται δύο κουμπιά:\n ΕΠΕΞΕΡΓΑΣΙΑ ΘΕΜΑΤΟΣ: Σας επιτρέπει την διαμόρφωση της ερώτησης.\n ΔΙΑΓΡΑΦΗ ΘΕΜΑΤΟΣ: Διαγράφει την επιλεγμένη ερώτηση", "ΕΠΙΣΚΟΠΗΣΗ ΘΕΜΑΤΩΝ");
        }

        private void toolStripMenuItem1_ti_einai_auth_h_egarmogh_Click(object sender, EventArgs e)
        {
            MessageBox.Show("ΠΑΠΑΔΕΣ ΚΑΝΕΙ\n\n\nΑυτή η εφαρμογή σας παρέχει τη δυνατότητα να δημιουργήσετε ερωτήσεις πολλαπλής επιλογής που μπορούν αργότερα να παραχτούν σε αρχεία word! \nΠατώντας τα αντίστοιχα κουμπιά επιλέγεται ", "Τι κάνει αυτή η εφαρμογή;");
        }
    }
}
